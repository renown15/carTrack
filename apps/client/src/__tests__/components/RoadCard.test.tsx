...
describe('RoadCard', () => {
  ...
  it('renders incident badges for each incident', () => {
    ...
    render(<RoadCard road={ROAD} status={status} onDelete={vi.fn()} />);
